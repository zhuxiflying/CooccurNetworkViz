...
public class HashtagStatistics {
	 ...
	 */
	private static void countFreqency() throws IOException {
		...
		{
			System.out.println(hashtag+","+hashtag_frequency.get(hashtag));
		}
	...
	private static void countDegree() throws IOException {
		...
		HashMap<Integer,Integer> degree_distribution = new HashMap<Integer,Integer>();
		for(String hashtag:hashtag_degree.keySet())
		{
		...
		String degree_distributionFile =  outputFolder +"degree_distribution.csv";
		FileWriter out2 = new FileWriter(degree_distributionFile);
		CSVPrinter printer2 = CSVFormat.DEFAULT.withHeader("degree", "frequency").print(out2);
